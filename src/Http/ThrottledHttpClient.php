...
/**
 * Decorator that enforces a minimum delay between consecutive requests to the same host, so a
 * crawler doesn't hammer sites — especially third-party ones it doesn't control — in a tight loop.
