...
This library provides the HTTP fetching, throttling, and robots.txt handling used by crawlers built on top of it;
SSRF, request-forgery, and denial-of-service concerns around that behavior are explicitly in scope.
